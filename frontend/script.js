...
function addScannedExpense(result) {
    ...
    document.getElementById('expenseAmount').value = result.total || '';
    document.getElementById('expenseCategory').value = result.category || 'Other';
    
    if (result.date) {
        document.getElementById('expenseDate').value = result.date;
    }
    
    document.getElementById('scanResults').className = 'scan-results';
    document.getElementById('scanResults').innerHTML = 'Expense form populated with scanned data!';
